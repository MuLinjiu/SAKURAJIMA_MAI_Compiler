...
br i1 %my_14, label %my_classQueue_int_push_15, label %my_classQueue_int_push_18
my_classQueue_int_push_15: 
%my_16 = load %class.Queue_int*, %class.Queue_int** %my_3
call void @classQueue_int_doubleStorage(%class.Queue_int* %my_16)
br label %my_classQueue_int_push_18

my_classQueue_int_push_18: 
...
br i1 %my_6, label %my_classQueue_int_pop_7, label %my_classQueue_int_pop_10
my_classQueue_int_pop_7: 
%my_8 = bitcast [37 x i8]* @my_.str.0 to i8*
call void @println(i8* %my_8)
br label %my_classQueue_int_pop_10

my_classQueue_int_pop_10: 
...
br label %my_classQueue_int_doubleStorage_37
my_classQueue_int_doubleStorage_37: 
%my_38 = load i32, i32* %my_35
%my_39 = load i32, i32* %my_12
%my_40 = icmp ne i32 %my_38, %my_39
br i1 %my_40, label %my_classQueue_int_doubleStorage_41, label %my_classQueue_int_doubleStorage_64

my_classQueue_int_doubleStorage_41: 
...
my_classQueue_int_doubleStorage_64: 
...
br label %my_classEdgeList_init_41
my_classEdgeList_init_41: 
%my_42 = load i32, i32* %my_40
%my_43 = load i32, i32* %my_6
%my_44 = icmp slt i32 %my_42, %my_43
br i1 %my_44, label %my_classEdgeList_init_45, label %my_classEdgeList_init_55

my_classEdgeList_init_45: 
...
br label %my_classEdgeList_init_52

my_classEdgeList_init_52: 
%my_53 = load i32, i32* %my_40
%my_54 = add nsw i32 %my_53, 1
store i32 %my_54, i32* %my_40
br label %my_classEdgeList_init_41

my_classEdgeList_init_55: 
store i32 0, i32* %my_40
br label %my_classEdgeList_init_56

my_classEdgeList_init_56: 
%my_57 = load i32, i32* %my_40
%my_58 = load i32, i32* %my_5
%my_59 = icmp slt i32 %my_57, %my_58
br i1 %my_59, label %my_classEdgeList_init_60, label %my_classEdgeList_init_70

my_classEdgeList_init_60: 
...
br label %my_classEdgeList_init_67

my_classEdgeList_init_67: 
%my_68 = load i32, i32* %my_40
%my_69 = add nsw i32 %my_68, 1
store i32 %my_69, i32* %my_40
br label %my_classEdgeList_init_56

my_classEdgeList_init_70: 
...
br i1 %my_8, label %my_main_9, label %my_main_48
...
br i1 %my_17, label %my_main_18, label %my_main_42
...
br i1 %my_24, label %my_main_25, label %my_main_28
...
br i1 %my_14, label %my_init_15, label %my_init_30
...
br i1 %my_18, label %my_spfa_19, label %my_spfa_27
...
br i1 %my_41, label %my_spfa_42, label %my_spfa_107
...
br i1 %my_56, label %my_spfa_57, label %my_spfa_106
...
br i1 %my_82, label %my_spfa_83, label %my_spfa_98
